...
class ResNet(object):
    ...
    def __init__(self, hps, images, labels, mode):
        ...
        :param images: Batches of images. [batch_size, image_size, images_size, 3]
        :param labels: Batches of labels. [batch_size, num_classes]
        :param mode: One of 'train' and 'eval'
        """
        self.hps = hps
        self._images = images
        self.labels = labels
    ...
    def _relu(self, x, leakiness = 0.0):
        """Rele, with optinal leaky support."""
        return tf.where(tf.less(x, 0.0), leakiness * x, x, name='leaky_relu')

    def _fully_connected(self, x, out_dim):
        """FullConnected layer for final output."""
