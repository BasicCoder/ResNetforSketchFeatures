...
def build_input(dataset, data_path, batch_size, mode):
    ...
    # Convert these examples to dense lables and processed images.
    ...
    if mode == 'train':
        ...
        # Brightness/saturation/contrast provides small gains .2%~.5% on cifar.
